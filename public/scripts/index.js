...
async function getLiveInfo(channelId) {
    ...
    timeLive(started);
    setInterval(() => timeLive(liveChannel.started),
        1000);
}
...
function displayLiveChannels(liveChannels) {
    ...
    liveChannels.forEach(liveChannel => {
        ...
        streamElement.addEventListener('click', function() {
            ...
            setInterval(() => timeLive(liveChannel.started), 1000);
...
document.querySelector('.back').addEventListener('click', () => {
    ...
    menuItems.forEach(item => {
        ...
        function scrollDown() {
            if (autoScroll && canScroll && !isNearBottom100()) {
                messages.scrollTo({
        ...
        // Verifica se está exatamente no fundo
        function isNearBottom100() {
            return messages.scrollHeight - messages.scrollTop - messages.clientHeight <= 0;
        }
